...
function onEachFeature(feature, reservoirLayer) {
    ...
    var content = '<iframe id="encoder_iframe"  width="700" height="460" src="http://127.0.0.1:8000/testiframe?stationid=&countryname=&riverbasin=&reservoirname=" frameborder="0"></iframe>';
