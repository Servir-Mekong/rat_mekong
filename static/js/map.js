...
function onEachFeature(feature, reservoirLayer) {
    ...
    var content = '<iframe id="encoder_iframe"  width="700" height="460" src="http://58.137.55.230/iframe?stationid=&countryname=&riverbasin=&reservoirname=" frameborder="0"></iframe>';
