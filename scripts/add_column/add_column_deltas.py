...
allFiles = glob.glob(os.path.join(os.path.dirname('./static/data/deltas/'), '*.txt'))
#print(allFiles)

path = os.path.join(os.path.dirname('./static/data/deltas/'))

for file in glob.glob(path+'/*.txt'):
    print(file)

    new_path = './static/data/csv/deltas/'
