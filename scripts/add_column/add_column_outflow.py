...
allFiles = glob.glob(os.path.join(os.path.dirname('./static/data/outflow/'), '*.txt'))
#print(allFiles)

path = os.path.join(os.path.dirname('./static/data/outflow/'))

for file in glob.glob(path+'/*.txt'):
    print(file)

    new_path = './static/data/csv/outflow/'
